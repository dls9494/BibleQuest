...
DB_PATH = "/home/david/Music/Bible Quiz/assets/bible/web.sqlite"
XML_PATH = "/tmp/bible_ref/World English Bible.xml"
...
def clean_text(text):
    if not text:
        return text
    # Replace Unicode replacement character with em-dash
    text = text.replace('\ufffd', '—')
...
def main():
    ...
    conn.close()
    print("Remediation of web completed successfully.")

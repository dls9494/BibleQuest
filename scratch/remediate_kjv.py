...
DB_PATH = "/home/david/Music/Bible Quiz/assets/bible/kjv.sqlite"
XML_PATH = "/tmp/bible_ref/King James Version (1769).xml"
...
def main():
    ...
    conn.close()
    print("Remediation of kjv completed successfully.")

...
class _MainScreenState extends rp.ConsumerState<MainScreen> {
  ...
  Widget _buildMainMenu() {
    ...
    final studyIcon = _buildFlatIcon(IconAssets.scriptureStudy, Icons.menu_book, Colors.cyan, size: 62);
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: GamifiedMenuCard(
                  title: "లేఖన పఠనం",
                  englishTitle: "Scripture Study",
                  subtitle: "Bilingual study",
                  iconWidget: studyIcon,
                  ...
                  verticalPadding: 6,
                  cardPadding: 4,
                  onTap: () => context.push('/study-tools'),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
